 ...
 */
package eeob.todobaratoapp.view;
 ...
 * @author Erick Ore
 */
public class TodoBaratoView extends javax.swing.JFrame {

    /**
     * Creates new form TodoBaratoView
     */
    public TodoBaratoView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Impuesto calculado:");

        txtImpuesto.setEditable(false);

        jLabel3.setText("Total calculado:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TodoBaratoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TodoBaratoView().setVisible(true);
            }
        });
    }
